...
.method public J(Landroid/view/View;Landroid/view/View;ZZ)Landroid/animation/AnimatorSet;
    ...
    .line 17
    invoke-static {v0, v13}, Ld1;->a(Landroid/animation/AnimatorSet;Ljava/util/List;)V
...
.method public final K(Landroid/view/View;)Landroid/view/ViewGroup;
    ...
    .line 1
    sget v0, Ldv;->mtrl_child_content_container:I
...
.method public final L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lyp;Lyp;FFFFLandroid/graphics/RectF;)V
    .registers 10

    .line 1
    invoke-virtual {p0, p2, p3, p5, p7}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lyp;FF)F

    move-result p3

    .line 2
    invoke-virtual {p0, p2, p4, p6, p8}, Lcom/google/android/material/transformation/FabTransformationBehavior;->S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lyp;FF)F
...
.method public final N(FFZLcom/google/android/material/transformation/FabTransformationBehavior$e;)Landroid/util/Pair;
    ...
    .line 1
    :cond_14
    iget-object p1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lxp;

    const-string p2, "translationXCurveUpwards"

    invoke-virtual {p1, p2}, Lxp;->h(Ljava/lang/String;)Lyp;

    move-result-object p1

    .line 2
    iget-object p2, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lxp;

    const-string p3, "translationYCurveUpwards"

    invoke-virtual {p2, p3}, Lxp;->h(Ljava/lang/String;)Lyp;
...
.method public final O(Landroid/view/View;Landroid/view/View;Lpt;)F
    .registers 6
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Lpt;)F
...
.method public final P(Landroid/view/View;Landroid/view/View;Lpt;)F
    .registers 6
    ...
    .line 5
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Lpt;)F
...
.method public final Q(Landroid/view/View;Landroid/view/View;Lpt;)F
    .registers 6
...
.method public final R(Landroid/view/View;Landroid/view/View;Lpt;)F
    .registers 6
...
.method public final S(Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lyp;FF)F
    .registers 13

    .line 1
    invoke-virtual {p2}, Lyp;->c()J

    move-result-wide v0

    .line 2
    invoke-virtual {p2}, Lyp;->d()J

    move-result-wide v2

    .line 3
    iget-object p1, p1, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lxp;

    const-string v4, "expansion"

    invoke-virtual {p1, v4}, Lxp;->h(Ljava/lang/String;)Lyp;
    ...
    .line 5
    invoke-virtual {p2}, Lyp;->e()Landroid/animation/TimeInterpolator;
    ...
    .line 6
    invoke-static {p3, p4, p1}, La1;->a(FFF)F
...
.method public final U(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 4
    sget-object p3, Lk6;->a:Landroid/util/Property;
    ...
    .line 5
    :cond_25
    sget-object p2, Lk6;->a:Landroid/util/Property;
    ...
    .line 9
    :goto_3c
    iget-object p2, p5, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lxp;
    ...
    .line 10
    invoke-virtual {p2, p1}, Lyp;->a(Landroid/animation/Animator;)V
...
.method public final W(Landroid/view/View;Landroid/view/View;ZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;)V
    ...
    .line 1
    iget-object v0, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {p0, p1, p2, v0}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Lpt;)F

    move-result v0

    .line 2
    iget-object v1, p4, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {p0, p1, p2, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Lpt;)F
    ...
    .line 10
    invoke-virtual {v1, v0}, Lyp;->a(Landroid/animation/Animator;)V

    .line 11
    invoke-virtual {p4, p1}, Lyp;->a(Landroid/animation/Animator;)V
...
.method public final X(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    invoke-static {p1}, Le60;->w(Landroid/view/View;)F
...
.method public final Y(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;FFLjava/util/List;Ljava/util/List;)V
    ...
    .line 3
    iget-object v1, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {v12, v0, v8, v1}, Lcom/google/android/material/transformation/FabTransformationBehavior;->O(Landroid/view/View;Landroid/view/View;Lpt;)F

    move-result v1

    .line 4
    iget-object v2, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {v12, v0, v8, v2}, Lcom/google/android/material/transformation/FabTransformationBehavior;->P(Landroid/view/View;Landroid/view/View;Lpt;)F
    ...
    .line 7
    iget-object v0, v9, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->a:Lxp;

    const-string v2, "expansion"

    invoke-virtual {v0, v2}, Lxp;->h(Ljava/lang/String;)Lyp;
    ...
    .line 10
    invoke-static/range {v2 .. v7}, Loo;->b(FFFFFF)F
    ...
    .line 23
    :goto_ab
    invoke-virtual {v14, v9}, Lyp;->a(Landroid/animation/Animator;)V
...
.method public final Z(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;)V
    ...
    .line 7
    :cond_23
    sget-object p3, Lqa;->b:Landroid/util/Property;
    ...
    invoke-virtual {p2, p4}, Lxp;->h(Ljava/lang/String;)Lyp;

    move-result-object p2

    .line 11
    invoke-virtual {p2, p3}, Lyp;->a(Landroid/animation/Animator;)V
...
.method public final c0(Landroid/view/View;Landroid/view/View;ZZLcom/google/android/material/transformation/FabTransformationBehavior$e;Ljava/util/List;Ljava/util/List;Landroid/graphics/RectF;)V
    ...
    .line 1
    iget-object v4, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {v10, v0, v1, v4}, Lcom/google/android/material/transformation/FabTransformationBehavior;->Q(Landroid/view/View;Landroid/view/View;Lpt;)F

    move-result v4

    .line 2
    iget-object v5, v3, Lcom/google/android/material/transformation/FabTransformationBehavior$e;->b:Lpt;

    invoke-virtual {v10, v0, v1, v5}, Lcom/google/android/material/transformation/FabTransformationBehavior;->R(Landroid/view/View;Landroid/view/View;Lpt;)F
    ...
    .line 10
    invoke-virtual/range {v0 .. v9}, Lcom/google/android/material/transformation/FabTransformationBehavior;->L(Landroid/view/View;Lcom/google/android/material/transformation/FabTransformationBehavior$e;Lyp;Lyp;FFFFLandroid/graphics/RectF;)V
    ...
    .line 13
    :goto_70
    invoke-virtual {v12, v14}, Lyp;->a(Landroid/animation/Animator;)V

    .line 14
    invoke-virtual {v13, v15}, Lyp;->a(Landroid/animation/Animator;)V
...
.method public final d0(Landroid/view/View;)I
    ...
    .line 1
    invoke-static {p1}, Le60;->s(Landroid/view/View;)Landroid/content/res/ColorStateList;
