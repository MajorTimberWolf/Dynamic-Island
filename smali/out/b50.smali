...
.method public static b(Landroid/content/Context;Landroid/content/res/Resources;I)Ljava/nio/ByteBuffer;
    ...
    .line 1
    invoke-static {p0}, Lb50;->e(Landroid/content/Context;)Ljava/io/File;
    ...
    :cond_8
    :try_start_8
    invoke-static {p0, p1, p2}, Lb50;->c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    :cond_12
    :try_start_12
    invoke-static {p0}, Lb50;->g(Ljava/io/File;)Ljava/nio/ByteBuffer;
...
.method public static c(Ljava/io/File;Landroid/content/res/Resources;I)Z
    ...
    .line 2
    :try_start_4
    invoke-static {p0, p1}, Lb50;->d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    .line 3
    invoke-static {p1}, Lb50;->a(Ljava/io/Closeable;)V
...
.method public static d(Ljava/io/File;Ljava/io/InputStream;)Z
    ...
    .line 5
    invoke-static {v3}, Lb50;->a(Ljava/io/Closeable;)V
    ...
    .line 8
    invoke-static {v2}, Lb50;->a(Ljava/io/Closeable;)V
...
.method public static h(Landroid/content/Context;[Lae$b;Landroid/os/CancellationSignal;)Ljava/util/Map;
    .registers 8
    ...
    .line 4
    :cond_12
    invoke-virtual {v3}, Lae$b;->d()Landroid/net/Uri;
    ...
    .line 6
    :cond_1d
    invoke-static {p0, p2, v3}, Lb50;->f(Landroid/content/Context;Landroid/os/CancellationSignal;Landroid/net/Uri;)Ljava/nio/ByteBuffer;
