...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p0, v2}, Ld30;->a(Landroid/view/View;Landroid/content/Context;)V
    ...
    .line 18
    sget-object v7, Law;->SwitchCompat:[I

    invoke-static {p1, p2, v7, p3, v1}, Lp30;->v(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lp30;

    move-result-object v2

    .line 19
    invoke-virtual {v2}, Lp30;->r()Landroid/content/res/TypedArray;
    ...
    .line 20
    invoke-static/range {v5 .. v11}, Le60;->n0(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V

    .line 21
    sget v4, Law;->SwitchCompat_android_thumb:I

    invoke-virtual {v2, v4}, Lp30;->g(I)Landroid/graphics/drawable/Drawable;
    ...
    .line 23
    :cond_5c
    sget v4, Law;->SwitchCompat_track:I
    ...
    .line 25
    :cond_69
    sget v4, Law;->SwitchCompat_android_textOn:I

    invoke-virtual {v2, v4}, Lp30;->p(I)Ljava/lang/CharSequence;
    ...
    .line 26
    sget v4, Law;->SwitchCompat_android_textOff:I
    ...
    .line 27
    sget v4, Law;->SwitchCompat_showText:I

    invoke-virtual {v2, v4, v3}, Lp30;->a(IZ)Z
    ...
    .line 28
    sget v4, Law;->SwitchCompat_thumbTextPadding:I

    invoke-virtual {v2, v4, v1}, Lp30;->f(II)I
    ...
    .line 29
    sget v4, Law;->SwitchCompat_switchMinWidth:I
    ...
    .line 30
    sget v4, Law;->SwitchCompat_switchPadding:I
    ...
    .line 31
    sget v4, Law;->SwitchCompat_splitTrack:I

    invoke-virtual {v2, v4, v1}, Lp30;->a(IZ)Z
    ...
    .line 32
    sget v4, Law;->SwitchCompat_thumbTint:I

    invoke-virtual {v2, v4}, Lp30;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 35
    :cond_ad
    sget v4, Law;->SwitchCompat_thumbTintMode:I

    const/4 v5, -0x1

    .line 36
    invoke-virtual {v2, v4, v5}, Lp30;->k(II)I

    move-result v4

    .line 37
    invoke-static {v4, v0}, Lza;->d(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 43
    :cond_cb
    sget v4, Law;->SwitchCompat_trackTint:I
    ...
    .line 46
    :cond_d7
    sget v4, Law;->SwitchCompat_trackTintMode:I
    ...
    .line 54
    :cond_f4
    sget v0, Law;->SwitchCompat_switchTextAppearance:I

    invoke-virtual {v2, v0, v1}, Lp30;->n(II)I
    ...
    invoke-direct {v0, p0}, Lt1;-><init>(Landroid/widget/TextView;)V

    iput-object v0, p0, Landroidx/appcompat/widget/SwitchCompat;->M:Lt1;

    .line 57
    invoke-virtual {v0, p2, p3}, Lt1;->m(Landroid/util/AttributeSet;I)V

    .line 58
    invoke-virtual {v2}, Lp30;->w()V
...
.method private getThumbScrollRange()I
    ...
    .line 5
    invoke-static {v0}, Lza;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 6
    :cond_12
    sget-object v0, Lza;->c:Landroid/graphics/Rect;
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 8
    invoke-static {v6}, Lza;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
    ...
    .line 9
    :cond_18
    sget-object v6, Lza;->c:Landroid/graphics/Rect;
    ...
    .line 24
    invoke-static {v0, v1, v2, v5, v4}, Lsa;->f(Landroid/graphics/drawable/Drawable;IIII)V
...
.method public drawableHotspotChanged(FF)V
    ...
    .line 3
    invoke-static {v0, p1, p2}, Lsa;->e(Landroid/graphics/drawable/Drawable;FF)V
...
.method public final i()V
    ...
    .line 3
    :cond_14
    invoke-static {p0, v0}, Le60;->F0(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public k(Landroid/content/Context;I)V
    ...
    .line 2
    sget p2, Law;->TextAppearance_android_textColor:I

    invoke-virtual {p1, p2}, Lp30;->c(I)Landroid/content/res/ColorStateList;
    ...
    .line 5
    :goto_17
    sget p2, Law;->TextAppearance_android_textSize:I

    const/4 v0, 0x0

    invoke-virtual {p1, p2, v0}, Lp30;->f(II)I
    ...
    .line 9
    :cond_33
    sget p2, Law;->TextAppearance_android_typeface:I

    const/4 v1, -0x1

    invoke-virtual {p1, p2, v1}, Lp30;->k(II)I

    move-result p2

    .line 10
    sget v2, Law;->TextAppearance_android_textStyle:I

    invoke-virtual {p1, v2, v1}, Lp30;->k(II)I
    ...
    .line 12
    sget p2, Law;->TextAppearance_textAllCaps:I

    invoke-virtual {p1, p2, v0}, Lp30;->a(IZ)Z
    ...
    invoke-direct {p2, v0}, Lb0;-><init>(Landroid/content/Context;)V
...
.method public onDraw(Landroid/graphics/Canvas;)V
    ...
    .line 12
    invoke-static {v4}, Lza;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
...
.method public onLayout(ZIIII)V
    ...
    invoke-static {p3}, Lza;->c(Landroid/graphics/drawable/Drawable;)Landroid/graphics/Rect;
