...
.method public bridge synthetic a(Ljava/lang/Object;IILgs;)Lex;
    ...
    invoke-virtual {p0, p1, p2, p3, p4}, Lmx;->c(Landroid/net/Uri;IILgs;)Lex;
...
.method public bridge synthetic b(Ljava/lang/Object;Lgs;)Z
    ...
    invoke-virtual {p0, p1, p2}, Lmx;->h(Landroid/net/Uri;Lgs;)Z
...
.method public c(Landroid/net/Uri;IILgs;)Lex;
    ...
    .line 2
    invoke-virtual {p0, p1, p2}, Lmx;->d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;

    move-result-object p2

    .line 3
    invoke-virtual {p0, p2, p1}, Lmx;->g(Landroid/content/Context;Landroid/net/Uri;)I

    move-result p1

    .line 4
    iget-object p3, p0, Lmx;->a:Landroid/content/Context;

    invoke-static {p3, p2, p1}, Lta;->b(Landroid/content/Context;Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;

    move-result-object p1

    .line 5
    invoke-static {p1}, Lgr;->f(Landroid/graphics/drawable/Drawable;)Lex;
...
.method public final d(Landroid/net/Uri;Ljava/lang/String;)Landroid/content/Context;
    ...
    .line 2
    iget-object p1, p0, Lmx;->a:Landroid/content/Context;
    ...
    .line 4
    iget-object v1, p0, Lmx;->a:Landroid/content/Context;
...
.method public final g(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 3
    invoke-virtual {p0, p1, p2}, Lmx;->f(Landroid/content/Context;Landroid/net/Uri;)I
    ...
    .line 5
    invoke-virtual {p0, p2}, Lmx;->e(Landroid/net/Uri;)I
...
.method public h(Landroid/net/Uri;Lgs;)Z
    .registers 3
